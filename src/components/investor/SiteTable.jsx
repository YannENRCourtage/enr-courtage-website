            ...
            {filteredSites.map((site) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Cost */}
                  <td className={`py-3 px-3 font-mono text-slate-900 text-[11px] font-bold ${isSold ? 'blur-[4px] opacity-40 select-none' : ''}`}>
                    {costDisplay}
                  </td>
                  ...
                  <td className="py-3 px-3 text-center">
                    {isSold ? (
                      <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-red-600 text-white border border-red-700 text-[10px] font-black uppercase tracking-wider shadow-sm">
                        Vendu !
                      </span>
                    ) : site.orange ? (
