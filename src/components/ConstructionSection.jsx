...
const ConstructionSection = () => {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative pt-20 md:pt-28 pb-16 md:pb-24 overflow-hidden bg-slate-950" aria-labelledby="construction-title">
        {/* Vidéo /2.mp4 en arrière-plan avec sous-imposition */}
        <video
          autoPlay
          loop
          muted
