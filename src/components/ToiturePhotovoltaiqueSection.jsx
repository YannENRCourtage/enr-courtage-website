...
const ToiturePhotovoltaiqueSection = () => {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative pt-12 md:pt-16 pb-16 md:pb-24 overflow-hidden bg-slate-950" aria-labelledby="toiture-title">
        {/* Vidéo /4.mp4 en arrière-plan avec sous-imposition */}
        <video
          autoPlay
          loop
          muted
