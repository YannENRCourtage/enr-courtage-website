      ...
      pillars: [
        {
          ...
          items: [
            '25 sites URBA OK — Permis de Construire purgés',
  ...
  },
  {
    ...
    teaserData: {
      ...
      stationSpecs: [
        ...
        { label: 'Énergie max en sortie (AC)', value: '88,1% soit MLP raisonnée' },
        { label: 'Sécurité Incendie', value: 'Liquide HVAC + Alfrood NFPA BESS' },
        { label: 'Raccordement Réseau Enedis', value: 'P/HTA 20 kV (Distance primoraccord. 10m)' },
        { label: 'Statut foncier Variable', value: 'Promesses de bail 20 ans signées (30+an)' },
        { label: 'Précision de PDR consultable', value: '88,1% soit MLP raisonnée su' },
      ],
      cycleTimeline: [
      ...
      cumulativeKpis: [
        { label: 'CA CUMULÉ 15 ANS', value: '47,12 M€', sub: 'Croissance tendancielle à +3.0%' },
        { label: 'EBITDA NET CUMULÉ 15 ANS', value: '28,06 M€', sub: 'Marge opérationnelle > 60% bottom line' },
        { label: 'CASH-FLOW NET POST-DETTES 15 ANS', value: '18,66 M€', sub: 'En réinvestissement fict. D.Net sur horizon 2037+' },
      ],
    },
  },
];
